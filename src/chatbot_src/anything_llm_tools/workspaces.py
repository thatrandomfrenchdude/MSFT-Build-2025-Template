...
"""
Use this tool to identify the correct workspace slug
for the chat api call.
"""
...
def workspaces(
    ...
    """
    Prints formatted json info about the available workspaces.
...
if __name__ == "__main__":
    ...
    api_key = config["ANYTHING_LLM_API_KEY"]
    base_url = config["ANYTHING_LLM_BASE_URL"]
